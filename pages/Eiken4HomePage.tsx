  ...
  return (
    <div className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <main className="grid grid-cols-1 gap-4 max-w-xl mx-auto">
        ...
        <button onClick={() => navigate('/eiken4/grade1-review')} className="w-full p-5 rounded-xl shadow-lg bg-amber-500 text-white text-left hover:shadow-xl active:scale-95 transition-all"><div className="flex items-center justify-between"><div><p className="text-xs font-bold opacity-90">英検学習に毎日5分追加</p><h2 className="text-xl font-bold">中1 単語・文法おさらい</h2><p className="text-sm opacity-90">基本単語3語＋基礎文法3問</p></div><ChevronRightIcon className="h-7 w-7 opacity-80"/></div></button>
