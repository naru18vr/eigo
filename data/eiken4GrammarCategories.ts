...
export const EIKEN4_GRAMMAR_CATEGORIES: Eiken4GrammarCategory[] = [
  { id: 'general-verb', title: '一般動詞', description: '「する・行く」など、動きを表す文', matches: sentence => /^(get up|want＋名詞|道案内)$/.test(tag(sentence)) },
  ...
  { id: 'imperative', title: '命令文', description: '〜してください・〜しましょうの文', matches: sentence => /^Let's \.\.$/.test(tag(sentence)) || /^(Please|Let's)/.test(words(sentence)) },
